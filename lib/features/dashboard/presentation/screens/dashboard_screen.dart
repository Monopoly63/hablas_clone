...
/// grouped by application, with storage monitors and quick actions.
...
class _DashboardScreenState extends State<DashboardScreen> with TickerProviderStateMixin {
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              'WhatsApp, Telegram, and more — all running in parallel.',
    ...
    return Row(
      children: [
        _buildStatCard(
          ...
          value: '${state.totalInstanceCount}',
          label: 'Total',
          color: AppTheme.liquidCyan,
        ),
        ...
        _buildStatCard(
          ...
          value: '${state.runningInstanceCount}',
          label: 'Active',
        ...
        _buildStatCard(
          ...
          value: _formatBytes(state.totalStorageBytes),
          label: 'Storage',
  ...
  Widget _buildAppGroup({
    ...
    required List<VirtualInstance> instances,
        ...
        Row(
          children: [
            ...
            Text(
              ...
              style: AppTheme.bodySmall.copyWith(color: AppTheme.cobaltBlue),
            ),
          ],
        ),
        const SizedBox(height: 8),
        ...instances.map((instance) {
          return Padding(
            ...
            child: GlassInstanceCard(
              instance: instance,
              onLaunch: () => context.read<DashboardBloc>().add(
                LaunchInstance(instance.id),
              ),
              onTerminate: () => context.read<DashboardBloc>().add(
